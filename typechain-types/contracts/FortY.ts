...
export interface FortYInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface FortY extends BaseContract {
  connect(runner?: ContractRunner | null): FortY;
  waitForDeployment(): Promise<this>;

  interface: FortYInterface;
